function f_recreate_transition_PE(init_ss,final_ss,file_in,file_out,trans_x,file_suffix,exovars)
%
...
%     par2.betaa = par2.betaa*P_t(t)/P_t(t+1);
    ...
    if t==1
        pol_01 = pol_0;
        pol_01.i_kpr = pol_t{t}.i_kpr;
        output2 = mainfuncMP_q1(par2,N,gr_now,pol_01,6,initval);
        g0_01  = output2.g1(:);

        pol_02 = pol_0;
        pol_02.pr_fstar_enter = pol_t{t}.pr_fstar_enter;
        output2 = mainfuncMP_q1(par2,N,gr_now,pol_02,6,initval);
        g0_02  = output2.g1(:);

        pol_03 = pol_0;
        pol_03.pr_stay = pol_t{t}.pr_stay;
        output2 = mainfuncMP_q1(par2,N,gr_now,pol_03,6,initval);
        g0_03  = output2.g1(:);

        pol_04 = pol_0;
        pol_04.i_kpr_up = pol_t{t}.i_kpr_up;
        output2 = mainfuncMP_q1(par2,N,gr_now,pol_04,6,initval);
        g0_04  = output2.g1(:);

        pol_05 = pol_0;
        pol_05.i_kpr = pol_t{t}.i_kpr;
        pol_05.pr_stay = pol_t{t}.pr_stay;
        output2 = mainfuncMP_q1(par2,N,gr_now,pol_05,6,initval);
        g0_05  = output2.g1(:);

        pol_06 = pol_0;
        pol_06.i_kpr = pol_t{t}.i_kpr;
        pol_06.i_kpr_up = pol_t{t}.i_kpr_up;
