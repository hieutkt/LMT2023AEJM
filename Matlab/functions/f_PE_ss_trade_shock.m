...
if nargin==3
    ...
    if par2.lam>0
        ...
        save([file_out '/ss_tradeshock_q1' file_suffix])
        save([file_out '/Pss_tradeshock_q1' file_suffix],'Pnow') 
    end
...
elseif nargin==2
    ...
    if par2.lam>0
        ...
        save([file_out '/ss_tradeshock_q1'])
        save([file_out '/Pss_tradeshock_q1'],'Pnow') 
    end
    ...
    if par2.lam>0
        ...
        save('mat_files/ss_tradeshock_q1')
        save('mat_files/Pss_tradeshock_q1','Pnow') 
    end
end
