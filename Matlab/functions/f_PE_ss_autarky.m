...
function output_moment = f_PE_ss_autarky(par_in,file_out,file_suffix)
...
function  yy = Fdiff_C(Mx,par, N, gr, pol, old_C)
    ...
    output_new  = mainfuncMP(par,N,gr_new,pol,4);
...
%     gr_new = gr;
%     gr_new.ps_dist = gr.ps_dist*Mx;
%     output_new  = mainfuncMP(par2,N,gr_new,pol,4);
