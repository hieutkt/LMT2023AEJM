...
disp("[f_transition_mkt_convex.m] Setting up grids...")
...
disp("[f_transition_mkt_convex.m] Load the initial steady state...")
...
disp("[f_transition_mkt_convex.m] Load the final steady state...")
...
%% solve time path
disp("[f_transition_mkt_convex.m] Solving for the tranistion path...")
...
disp("[f_transition_mkt_convex.m] Computing the statistics along transition path...")
...
disp(sprintf("[f_transition_mkt_convex.m] export full workspace to %d/transition*", file_out))
