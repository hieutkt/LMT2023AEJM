...
function output_moment = f_PE_ss_covid_convex(par_in,file_out,file_suffix)

%% parameters and grids: set baseline parameter
disp("[f_PE_ss_covid_convex.m] Setting up parameters & grid...")
...
disp("[f_PE_ss_covid_convex.m] We're going to vary P to clear C, holding fix M at autarky value.")
disp("[f_PE_ss_covid_convex.m] Solve GE via bisection...")
...
%% compute moments
disp("[f_PE_ss_covid_convex.m] Computing the relevant moments...")
...
disp(sprintf("[f_PE_ss_covid_convex.m] export the workspace to %d/ss_tradeshock or Pss_tradeshock...", file_out))
