% model_sigstar.m
%
%   Model with convex costs, recalibrated to hit sigma(omega)
%
...
switch model
    case 'baseline'
        ...
        closed_moments = f_PE_ss_autarky_convex(par_in,mat_out,'_high_sigma');
        
        % save measure of entrants
        load([mat_out '/ss_autarky_high_sigma'], 'Me_new');
        Mnow = Me_new;
    ...
    case{'frictionless'}
        ...
        par_in.Me = Mnow;
        closed_moments = f_ss_autarky(par_in,mat_out,'_high_sigma');
...
switch model
    case 'baseline'
        load([mat_out '/Pss_autarky_high_sigma'], 'Pnow')
        
    case 'frictionless'
        load([mat_out '/Pss_autarky_q1_high_sigma'], 'Pnow')     
end
...
switch model
    case 'baseline'
        ...
        load([mat_out '/kmax_autarky_high_sigma'], 'kmax_autarky')
        
    case 'frictionless'
        
        load([mat_out '/kmax_autarky_q1_high_sigma'], 'kmax_autarky')
...
switch model
    case{'baseline'}
        opened_moments = f_PE_ss_trade_shock_convex(par_in,mat_out,'_high_sigma');
    
    case{'frictionless'}
        opened_moments = f_PE_ss_trade_shock(par_in,mat_out,'_high_sigma');
    
end

% %%%
%  goldenx(@cali_trade,0, 1,par_in,mat_out)
% %%%
...
switch model
    case 'baseline'
        f_transition_mkt_convex('ss_autarky_high_sigma','ss_tradeshock_high_sigma',mat_out,t_trans,'_high_sigma')
        
    case 'frictionless'
        f_transition_mkt('ss_autarky_q1_high_sigma','ss_tradeshock_q1_high_sigma',mat_out,t_trans,'_high_sigma')
end
